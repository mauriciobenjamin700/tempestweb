...
|---|---|---|
| **C** | Mode C — transpile (Python → native JS) | [Mode C — transpile](advanced/transpile.md) |
| **N** | `native/` capabilities (typed Web APIs) | [Capabilities](advanced/capabilities.md) |
| **O** | Observability / production (adapter pattern) | [Observability](advanced/observability.md) |
| **P** | PWA / offline-first / WebPush | [PWA & offline](advanced/pwa.md) |
| **B5** | SSE transport (alternative to WebSocket) | [Wire contract](advanced/wire-contract.md) |
...
Want to start using it? Head to the [Installation](tutorial/installation.md) and do the
