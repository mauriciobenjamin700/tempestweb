...
- [Capacidades nativas](../advanced/capabilities.md) — o modelo de bridge
...
- 💡 Leia o [contrato de wire format](../advanced/wire-contract.md) para entender como `native_call`/`native_result` trafegam no Modo B
