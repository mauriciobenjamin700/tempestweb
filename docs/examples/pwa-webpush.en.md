...
- [PWA and offline](../advanced/pwa.en.md) — the P track of the roadmap
...
```bash
tempestweb dev --mode server --path examples/pwa-webpush
```
...
- 💡 Explore the [PWA documentation](../advanced/pwa.en.md) for the Service Worker (P1) and
