...
- Os componentes `Rating` e `Chip` vêm de `tempest_core.components`.
- `Wrap` (de `tempest_core.widgets`) distribui os chips em múltiplas linhas
...
```bash
tempestweb dev --mode server --path examples/rating-review
```
