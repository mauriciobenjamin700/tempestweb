...
```bash
tempestweb dev --mode wasm     --path examples/todo   # Python in the browser (Pyodide)
tempestweb dev --mode server   --path examples/todo   # Python on the server (FastAPI + WS)
```
