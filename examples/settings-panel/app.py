            ...
            Row(
                ...
                children=[
                    ...
                    Switch(
                        ...
                        key="notif-switch",
                        semantics=Semantics(label="Enable notifications"),
                    ),
                ],
            ),
            Checkbox(
                ...
                key="email-checkbox",
                semantics=Semantics(label="Send e-mail alerts"),
            ),
            Checkbox(
                label="Play sounds",
                ...
                key="sound-checkbox",
                semantics=Semantics(label="Play sounds"),
            ),
        ],
    )
    ...
    return Card(
        ...
        children=[
            ...
            Slider(
                ...
                key="font-slider",
                semantics=Semantics(label="Font size"),
            ),
            Text(
    ...
    return Card(
        ...
        children=[
            ...
            Slider(
                ...
                key="volume-slider",
                semantics=Semantics(label="Playback volume"),
            ),
            Row(
                key="auto-save-row",
                style=Style(gap=12.0, align=AlignItems.CENTER),
                children=[
                    ...
                    Switch(
                        ...
                        semantics=Semantics(label="Auto-save drafts"),
                    ),
                ],
            ),
        ],
