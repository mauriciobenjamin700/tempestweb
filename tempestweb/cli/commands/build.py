...
# native/offline.js's imports; asset-cache.js (large-binary caching) is an opt-in
# module an app imports directly.
_OFFLINE_ASSETS: tuple[str, ...] = ("store.js", "sync.js", "asset-cache.js")
