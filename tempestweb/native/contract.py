...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    _cap("imaging.compress", mode_c=True),
    _cap("imaging.thumbnails", mode_c=True),
    _cap("imaging.transform", mode_c=True),
    _cap("imaging.info", mode_c=True),
    _cap("imaging.read", mode_c=True),
    _cap("imaging.release", mode_c=True),
    ...
    _cap("sync.configure", mode_c=True),
    _cap("sync.now", mode_c=True),
    _cap("sync.status", mode_c=True),
    _cap("sync.watch", mode_c=True, streaming=True),
    ...
    _cap("webaudio.levels", mode_c=True, streaming=True),
    _cap("webaudio.sequence", mode_c=True),
    _cap("webaudio.stop", mode_c=True),
